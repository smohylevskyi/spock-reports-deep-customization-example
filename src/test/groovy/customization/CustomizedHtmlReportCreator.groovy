...
@Slf4j
class CustomizedHtmlReportCreator extends AbstractHtmlCreator<SpecData>
    ...
    CustomizedHtmlReportCreator() {
        reportAggregator = new HtmlReportAggregator()
    }

    CustomizedHtmlReportCreator( HtmlReportAggregator reportAggregator ) {
    ...
    protected String reportHeader( SpecData data ) {
        "Custom report for ${Utils.getSpecClassName( data )}"
    }
